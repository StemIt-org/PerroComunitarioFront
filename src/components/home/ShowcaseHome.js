    ...
    if (this.state.perros) {
      ...
      return (
        <div className="text-center colorFondoAdopcion-home borderRadius p-3 adopcion-home-container">
          ...
          <Row>
            {this.state.perros.length >= 3 && this.state.perros.map((perro) => {
              return (
                <Col xs={12} lg={4} key={perro.id_perro}>
                  ...
                  />
                  <div>
                    <Link to={"/adopcion/" + perro.id_perro}><p style={{ padding: '5px', background: '#8b3637', width: '40%', borderRadius: '10px', textAlign: 'center', marginLeft: 'auto', marginRight: 'auto' }}>Detalles!</p></Link>
                  </div>
                </Col>
              )
            })}
            {this.state.perros.length === 2 && this.state.perros.map((perro) => {
              return (
            ...
            {this.state.perros.length === 1 && this.state.perros.map((perro) => {
              return (
      ...
      return (
        <div className="text-center colorFondoAdopcion-home borderRadius p-3 adopcion-home-container">
          ...
          <Row>
            ...
            <Col xs={12} lg={4}>
              <h2 className="negrita" style={{color: 'transparent',background: '#8b3637',width: '40%', marginLeft: 'auto', marginRight: 'auto' }}>nombre</h2>
            
              <div className="fake-img-showcase-home"/>
              <div>
                <p style={{ padding: '5px', background: '#8b3637', width: '40%', borderRadius: '10px', textAlign: 'center', marginLeft: 'auto', marginRight: 'auto', color: 'transparent' }}>---------</p>
              </div>
            </Col>
            <Col xs={12} lg={4}>
              <h2 className="negrita" style={{color: 'transparent',background: '#8b3637',width: '40%', marginLeft: 'auto', marginRight: 'auto' }}>nombre</h2>
